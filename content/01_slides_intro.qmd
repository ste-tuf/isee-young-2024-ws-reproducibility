...
![](https://www.science.org/cms/10.1126/science.1213847/asset/f9cbf336-6179-40e1-876d-45f9591423a9/assets/graphic/334_1226_f1.jpeg){fig-alt="reproducibility spectrum"
fig-align="center"}
...
2.  Can you perform data manipulation tasks using `dplyr` or
    `data.table`?
3.  Have you written and executed an R script that includes statistical
    modeling or machine learning?

If you answered "No" to all three questions: **Beginner** If you
answered "Yes" to one or two questions: **Intermediate** If you answered
"Yes" to all three questions: **Advanced**
