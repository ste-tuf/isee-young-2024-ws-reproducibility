...
There are many definitions of a project: it can be a single analysis for a paper or an entire cohort study with different papers.

For this workshop: we'll refer to a folder on your computer.
...
-   `commit`: create a snapshot of changes and save it in Git `history`.
    Commits can have a short description of the changes
